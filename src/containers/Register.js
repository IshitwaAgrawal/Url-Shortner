    ...
    return (
        <div className="register__main">
            ...
            <div className="register__main__box">
                <InputElement heading="E-Mail" placeholder="Enter your email" value={email} setValue={setEmail} />
                <InputElement heading="First Name" placeholder="Enter your first name" value={first_name} setValue={setFirstName} />
                <InputElement heading="Last Name" placeholder="Enter your last name" value={last_name} setValue={setLastName} />
